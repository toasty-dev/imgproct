...
do
	...
	local tabSystem = {
		...
		cache = {
			{
				title = "Script 1",
				content = "print(' Welcome To Aurora!');",
				index = 1
			}
		},
	...
	function tabSystem:Add(title: string, content: string?)
		...
		local newTab = {
			title = title,
			content = content or "print('Welcome To Aurora!');",
			index = index
		};
...
do
    ...
    return instanceUtils:Create("TextButton", tableUtils:DeepOverwrite({ 
        BackgroundColor3 = Color3.fromRGB(148, 0, 211), -- Violet color (RGB: 148, 0, 211)
        BorderSizePixel = 0, 
...
do
	...
	stanceUtils:Create("GetTextBoundsParams", {
...
function navbarButton:Highlight(selected: boolean)
    instanceUtils:Tween(self.instance.icon, 0.2, {
        ImageColor3 = selected and Color3.fromRGB(148, 0, 211) or Color3.fromHex("979ebd"), -- Violet color (RGB: 148, 0, 211)
...
do
    ...
    return instanceUtils:Create("TextButton", tableUtils:DeepOverwrite({
        AutomaticSize = Enum.AutomaticSize.X,
        BackgroundColor3 = Color3.fromRGB(148, 0, 211), -- Violet color (RGB: 148, 0, 211)
        Font = Enum.Font.GothamBlack, -- Changed font to GothamBlack
        Size = UDim2.new(0, 0, 0, 32),
        TextColor3 = Color3.fromRGB(255, 255, 255), -- White text color
        TextSize = 18, -- Increased text size to 18
        TextTruncate = Enum.TextTruncate.AtEnd,
        TextWrapped = true,
        TextXAlignment = Enum.TextXAlignment.Center,
        TextYAlignment = Enum.TextYAlignment.Center
    ...
    return instanceUtils:Create("Frame", tableUtils:DeepOverwrite({
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(148, 0, 211), -- Violet color (RGB: 148, 0, 211)
        BackgroundTransparency = 0.5, -- Increased transparency for a subtle effect
        BorderSizePixel = 0,
        Name = "background",
        Position = UDim2.new(0.5, 0, 0.5, 0),
...
framework.components.base.textLabel = (function(overwriteProps: {any}, children: {any}): Instance
    return instanceUtils:Create("TextLabel", tableUtils:DeepOverwrite({
        ...
        BackgroundTransparency = 1,
        Font = Enum.Font.GothamBold, -- Changed font to GothamBold
        Size = UDim2.new(),
        TextColor3 = Color3.fromRGB(148, 0, 211), -- Violet text color (RGB: 148, 0, 211)
        TextSize = 16, -- Increased text size to 16
        TextTruncate = Enum.TextTruncate.AtEnd,
        TextWrapped = true,
        TextXAlignment = Enum.TextXAlignment.Center,
        TextYAlignment = Enum.TextYAlignment.Center
    ...
    local base = instanceUtils:Create("Frame", { 
        AnchorPoint = Vector2.new(0.5, 0.5), 
        BackgroundColor3 = Color3.fromRGB(148, 0, 211), -- Purple color (RGB: 148, 0, 211)
        ...
        instanceUtils:Create("UIStroke", { 
            Color = Color3.fromRGB(32, 32, 40), -- Changed stroke color
            Name = "stroke", 
            Thickness = 2
        }),
        instanceUtils:Create("TextLabel", { 
            ...
            BackgroundTransparency = 1, 
            Font = Enum.Font.GothamBold, -- Changed font
        ...
        instanceUtils:Create("Frame", { 
            ...
            AutomaticSize = Enum.AutomaticSize.Y, 
            BackgroundColor3 = Color3.fromRGB(255, 255, 255), -- Changed button background color to white
            BackgroundTransparency = 1, 
            BorderColor3 = Color3.fromRGB(0, 0, 0), 
            BorderSizePixel = 0, 
            Name = "buttons", 
            ...
            instanceUtils:Create("TextButton", { 
                AutoButtonColor = false, 
                BackgroundColor3 = Color3.fromRGB(58, 58, 74), -- Changed button background color
                BorderColor3 = Color3.fromRGB(0, 0, 0), 
                BorderSizePixel = 0, 
                Font = Enum.Font.GothamBold, -- Changed font
                FontSize = Enum.FontSize.Size14, 
        ...
        instanceUtils:Create("ImageLabel", { 
            ...
            BackgroundColor3 = Color3.fromRGB(255, 255, 255), -- Changed image background color to white
            BorderColor3 = Color3.fromRGB(0, 0, 0), 
            BorderSizePixel = 0, 
            Image = "", 
            Name = "icon", 
